...
def select_port():
    ...
    print("COM ports found " + str(len(found_ports)))
...
def verify_cb():
    ...
    # compile_command = [arduino_cli_cmd,  "compile", "-b" , selected_board, "--output-dir", "./RUI3-Modular/flash-files", "--build-path", "./RUI3-Modular/build", "--build-cache-path", "./RUI3-Modular/cache", "--no-color", "--verbose", "--library", "./RUI3-Modular/libraries", "./RUI3-Modular/RUI3-Modular.ino"]
        ...
        if not os.path.exists("Arduino15.zip"):
            ...
            try:
                ...
                if not os.path.exists("Arduino15"):
                    ...
                    output_field.insert(
                        tk.END, "Installing the BSP's, be patient")
